# Generated by Django 5.0.1 on 2024-11-16 18:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audience', models.CharField(choices=[('all', 'All'), ('guardian', 'Guardians'), ('student', 'Students')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2024, 11, 16, 19, 15, 7, 988503))),
                ('updated_at', models.DateTimeField(default=datetime.datetime(2024, 11, 16, 19, 15, 7, 988503))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classes', models.ManyToManyField(related_name='subjects_set', to='core.class')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.IntegerField(blank=True, null=True)),
                ('class_assigned', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='core.class')),
                ('questions', models.ManyToManyField(blank=True, related_name='assessment', to='core.onlinequestion')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.subject')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('continuous_assessment_1', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, validators=[django.core.validators.MaxValueValidator(10.0)])),
                ('continuous_assessment_2', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, validators=[django.core.validators.MaxValueValidator(10.0)])),
                ('continuous_assessment_3', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, validators=[django.core.validators.MaxValueValidator(10.0)])),
                ('assignment', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, validators=[django.core.validators.MaxValueValidator(10.0)])),
                ...
                ('exam_score', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True, validators=[django.core.validators.MaxValueValidator(40.0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='core.student')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.CharField(max_length=15, null=True)),
                ('address', models.TextField()),
                ('current_class', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='enrolled_class', to='core.class')),
            ],
        ),
        migrations.AddField(
            model_name='class',
